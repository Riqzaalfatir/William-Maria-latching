...
interface EventOrderProps {
  data?: {
    ...
    logoImage?: string; // ← tambahan baru
  };
}
...
function buildMapsLink(latLong?: string): string {
  if (!latLong) return "https://maps.app.goo.gl/itNvPF8tGYZR4Whq9"; // fallback lama
      ...
      <div className="pt-[20.51vw] lg:pt-[116px]">
        ...
        <div className="pt-[10.51vw] lg:pt-[45px] flex flex-col items-center justify-center leading-none">
          ...
          <div className="flex flex-col items-center text-center justify-center leading-none">
            ...
            >
              {/* TODO: dress code masih hardcode, belum ada field di data sesi */}
          ...
          {/* DRESS CODE DETAIL — tetep statis, nggak ada field-nya di API */}
          <div
            id="dresscode"
